...
## Scenario
During a regular IT security check at GlobalTech Industries, abnormal network traffic was detected from multiple workstations.<br><br>
Upon initial investigation, it was discovered that certain employees' search queries were being redirected to unfamiliar websites.<br><br>
This discovery raised concerns and prompted a more thorough investigation.<br><br>
...
Malware family name is different by vendors. In this lab, we need to rely on Red Canary.<br><br>
Unfortunately, "Detection" tab didn't show one. Moved to "Relations" tab, and clicked the graph (you need to log-in).<br><br>
In the graph, there were several collections (reports), and one of them was published by Red Canary.<br><br>
<img width="1916" height="821" alt="image" src="https://github.com/user-attachments/assets/8619f50a-b230-4df8-94aa-62241bae828d" />
<br><br>
[The report](https://otx.alienvault.com/pulse/5fcab7a1accb28c015a5717d) showed the malware family name.<br><br>
...
Common filenames can be seen at Details tab.<br><br>
...
Compilation timestamp can be found at Details tab as well.<br><br>
...
Investigated Detail tab in VirusTotal.<br><br>
...
The report in Q1 has the link to [the detailed report](https://redcanary.com/blog/threat-intelligence/yellow-cockatoo/), which contains the .dat file name.<br><br>
...
The above screenshot contains the C2 server as well.<br><br>

...
## Scenario
The accountant at the company received an email titled "Urgent New Order" from a client late in the afternoon. <br><br>
When he attempted to access the attached invoice, he discovered it contained false order information. Subsequently, the SIEM solution generated an alert regarding downloading a potentially malicious file.<br><br>
Upon initial investigation, it was found that the PPT file might be responsible for this download. <br><br>
...
Opened the downloaded file and found the MD5 hash (12c1842c3ccafe7408c23ebf292ee3d9).<br><br>
...
Put the hash into VirusTotal, and found the creation time at Details tab.<br><br>
...
Moved to Relation tab and found the C2 server.<br><br>
...
Moved to Behavior tab and investigated dropped files.<br><br>
...
Examined the Any.run report, and found the RC4 key.<br><br>
...
Opened the sandbox report, and moved to ATT&CK.<br><br>
<img width="795" height="279" alt="image" src="https://github.com/user-attachments/assets/bfc69900-c416-409f-b4e4-053e90403d57" />
<br><br>
The matrix had several techniques related to credential access.<br><br>
<img width="1822" height="717" alt="image" src="https://github.com/user-attachments/assets/29bcb83c-8110-41f9-a506-20888a575ed1" />
<br><br>
Steal Web Session Cookie and Unsecured Credentials may not be the first choice because we need to consider password stealing.<br><br>
"Credentials from Password Stores" should be the first choice in this case.<br><br>
...
Came back to the top page, and investigated the child process (cmd.exe).<br><br>
The malware attempted to delete all DLL files at C:\ProgramData before exit.<br><br>
...
Still investigated the child process. It set the timeout (delay) before self-deletion.<br><br>
